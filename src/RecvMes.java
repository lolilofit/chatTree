...
public class RecvMes {
    ...
    private void isSafeChanged() {
        ...
        Pair<Integer, String> oldSafe = findSafeNode.getSafeNode(selfPair);
        if(oldSafe != null) {
            findSafeNode.findSafeNode(selfPair, neigh.keySet());
            Pair<Integer, String> newSafe = findSafeNode.getSafeNode(selfPair);
            if(newSafe != null) {
            ...
            try {
               ...
               */
                ...
                if(Integer.parseInt(splitMes[0]) == 1) {
                    ...
                    sendAnswer(splitMes[1], splitMes[2], packet);
                    readNode.sendNeigh(splitMes[2], new Pair<>(packet.getPort(), "127.0.0.1"));
